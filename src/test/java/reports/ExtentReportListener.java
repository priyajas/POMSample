...
public class ExtentReportListener extends ExtentManager implements ITestListener {
    ...
    public void onTestSuccess(ITestResult result) {
        ...
        WebDriver driver = ((TestBaseClass) result.getInstance()).getDriver();
    ...
    public void onFinish(ITestContext context) {
        try {
           ...
           String filePath = System.getProperty("user.dir") + "/src/test/java/test-output/TestExecutionReport.json";
